"""B3 + B4: trainable stock-aware attention pooling + conventional TCN mixture."""
...
def train_b3_b4(
    ...
    """Run the B3+B4 temporal pipeline."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train the B3+B4 TCN baseline.")
    add_temporal_args(parser, news_pooling="b3")
    parser.set_defaults(output_dir="data/predictions/b3_b4")
    args = parser.parse_args()
    metadata = train_b3_b4(
